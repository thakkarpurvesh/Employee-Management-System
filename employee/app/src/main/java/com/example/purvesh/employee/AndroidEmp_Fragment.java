...
public class AndroidEmp_Fragment extends android.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview= inflater.inflate(R.layout.fragment_android_emp_, container, false);
        ...
        Cursor c = db.rawQuery("SELECT * FROM register where technical='android' or technical='Android' or technical='ANDROID' ", null);
