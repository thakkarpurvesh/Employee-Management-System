...
public class DotnetEmp_Fragment extends android.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview= inflater.inflate(R.layout.fragment_dotnet_emp_, container, false);
        ...
        Cursor c = db.rawQuery("SELECT * FROM register where technical='dotnet' or technical='Dotnet' or technical='DOTNET' ", null);
