...
public class PhpEmp_Fragment extends android.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview= inflater.inflate(R.layout.fragment_php_emp_, container, false);
        ...
        Cursor c = db.rawQuery("SELECT * FROM register where technical='php' or technical='Php' or technical='PHP' ", null);
